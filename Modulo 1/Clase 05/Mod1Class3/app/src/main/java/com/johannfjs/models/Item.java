...
public class Item {
    private int id;
    private String textoUno, textoDos, textoTres, tiempo, imagen;
    private boolean cancel;

    public Item(int id, String textoUno, String textoDos, String textoTres, String tiempo, String imagen, boolean cancel) {
        this.id = id;
